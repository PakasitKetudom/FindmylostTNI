...
public class mainLost extends AppCompatActivity {
    ...
    public void showlost(){
        ...
        try {
            ...
            for (int i = 0; i < part.length; i++) {
                ...
                /*SimpleDateFormat simpleDate =  new SimpleDateFormat("dd/MM/yyyy");
                String newFdate = simpleDate.format(part2[2].toString());*/
            ...
            br.close();
            myAdapter = new SimpleAdapter(mainLost.this, fill_data, R.layout.display_layout, from, to);
            ...
            Toast.makeText(mainLost.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
        ...
        display.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent goElost = new Intent(mainLost.this, EditLost.class);
                String res = "";
